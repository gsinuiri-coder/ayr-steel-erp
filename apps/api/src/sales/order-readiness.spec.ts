...
describe('deriveOrderReadiness', () => {
  it.each([
    ...
    // OPs canceladas
    [[{ status: 'CANCELLED', orderedMl: '10', reportedMl: '10' }], 'SIN_PRODUCCION', '0.000', '0.000'],
    
    // Producción normal
    [[{ status: 'IN_PROGRESS', orderedMl: '10.500', reportedMl: '4.000' }], 'EN_PRODUCCION', '10.500', '4.000'],
    
    // Listo perfecto
    [[{ status: 'CLOSED', orderedMl: '10.000', reportedMl: '10.000' }], 'LISTO', '10.000', '10.000'],
    
    // Cierre corto (LISTO_CON_FALTANTE)
    [[{ status: 'CLOSED', orderedMl: '10.000', reportedMl: '8.000' }], 'LISTO_CON_FALTANTE', '10.000', '8.000'],
    ...
    [
      ...
      'LISTO_CON_FALTANTE', '20.000', '19.000'
    ],
