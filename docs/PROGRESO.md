...
| Sesión Comprobantes manuales — D-131 a regla dura y D-153                                       | ✅ Cerrada (2026-09-08)    | D-131 elevada a regla dura 14 con centinela; D-153 (un borrador tiene dos terminales: emitir por el PSE o registrar manual). 279/279 unitarios; E2E de comprobante manual 5/5 y regresión de facturación con las fallas conocidas del cupo del PSE demo. Desplegado en la ventana HOTFIX (2026-09-10, `946ce0e`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Sesión Planta II — guard de reservas, espacio de producción, UX del importador                  | ✅ Cerrada (2026-09-09)    | D-154 (el faltante de materia prima avisa y no bloquea en producción; un pedido no se bloquea a sí mismo), D-155 (`/planta/producir`: una pestaña por orden, guardado por orden, retira la tanda de D-147), D-156 (ningún campo obligatorio es un callejón: alta express y selects buscables). Regla dura 15 (puertos 4000/4001 del dueño) y `pnpm dev:preview`. Desplegado en la ventana HOTFIX (2026-09-10, `946ce0e`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Sesión Planta III — importador asentado y una sola forma de producir                            | ✅ Cerrada (2026-09-09)    | D-157 (una cotización puede no vencer), D-158 (el cliente se crea del padrón), D-159 (plan de corte con largo bloqueado), D-160 (producir queda en un solo lugar). Desplegado en la ventana HOTFIX (2026-09-10, `946ce0e`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Sesión Precios — plancha por metro, valor contra precio y piso duro                             | ✅ Cerrada (2026-09-09)    | D-161 (la plancha de catálogo se cotiza por metro lineal), D-162 («valor de venta» sin IGV contra «precio de venta» con IGV), D-163 (piso duro con el margen sobre la venta, para todos los roles). 341/341 unitarios; 69/69 E2E de los specs afectados. Desplegado en la ventana HOTFIX (2026-09-10, `946ce0e`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Sesión Cierre de bobina — remanente liquidado y merma normal en el estándar                     | ✅ Cerrada (2026-09-09)    | D-164 (cerrar una bobina liquida su remanente como movimiento `CLOSE_ADJUSTMENT` en la misma transacción; reabrir lo revierte), D-165 (el 1 % de merma normal se absorbe en la densidad estándar, en código y en un solo lugar). `pnpm check:price-floor` (solo lectura) para decidir el aviso de mínimo en el POS. Regla dura 16 (ningún texto largo pasa por la shell). 352/352 unitarios; 5/5 E2E de D-164. Desplegado en la ventana HOTFIX (2026-09-10, `946ce0e`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Sesión Largo de la plancha — el campo pedía mm y el catálogo tenía metros                       | ✅ Cerrada (2026-09-09)    | D-166 (el largo fijo de una plancha tiene que ser posible, y el campo dice en qué unidad va). Bugfix de la captura del dueño: las tres planchas del catálogo estaban en metros y D-161 multiplicaba por ese número — S/ 0.28 en vez de S/ 330. 357/357 unitarios; 3/3 E2E de pantalla y 33/33 de regresión. Desplegado en la ventana HOTFIX (2026-09-10, `946ce0e`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Sesión S11 — T7: escritorio robusto y compacto, color e inspección de flujos                    | ✅ Cerrada (2026-09-11)    | D-179 (escritorio compacto: el sistema se diseña para una sola clase de pantalla; +76 %/+76 %/+49 %/+103 % de filas por pantalla en las cuatro listas principales) y D-180 (paleta sobria de un solo acento y cuatro tonos de estado de dominio, con rojo y ámbar reservados para error y aviso). Antes de tocar producto, `docs/analisis/s11-inspeccion-flujos.md`: los cinco flujos recorridos en un navegador real, con dos hallazgos que mandan — toda la app se renderizaba en Times New Roman (arreglado), y con transporte no se puede despachar ninguna línea que no se mida en kilos porque el formulario nunca pide el peso por línea que el API exige (documentado para Fase 8, no tocado). 239/239 E2E locales (2 saltados), 399 unitarios, lint/typecheck/format en verde. Desplegado en la Ventana V-2 (2026-09-11), junto con S9/S10/S10b.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Sesión F8-S1 — integridad: doble click, idempotencia, weightKg                                  | ✅ Cerrada (2026-09-12)    | M1 (botón en vuelo universal, `Button` gana `pending`/`pendingText`; los dos huecos que encontró `revisor` — `PaymentForm` sin sumar al `busy` del padre y el guard de doble Enter faltante en `ReasonDialog`/`BackdateConfirmDialog` — corregidos en la misma sesión), M2 (D-182: idempotencia server-side; único hallazgo real de la auditoría, `issueDispatchNote` sin lock de fila, corregido; `IdempotencyKey` + `claimIdempotencyKey` para reportar producción y pagos), M3 (D-183: el despacho pide el peso por línea que el API ya exigía, prellenado con el kg teórico). 399/399 unitarios; 250/252 E2E locales (2 saltados por el cupo del PSE demo), incluidos los 4 tests nuevos de esta sesión (1 de M3 por el form, 3 de concurrencia de M2). Desplegado en la Ventana V-3 (2026-09-14). Handoff: `docs/handoff/f8-s1-integridad.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Sesión F8-S2 — flujo comercial nuevo (emitir directo, reserva temporal, confirmar en un paso)   | ✅ Cerrada (2026-09-12)    | M0 (clave de idempotencia en reporte, cobro, pago y agregar ítems), M1 (D-184: la cotización nace emitida y se edita hasta confirmarla), M2 (D-185: reserva temporal con expiración perezosa y suma de reservado centralizada), M3 (D-186: confirmar = pedido + reserva firme + OPs con vista previa; bloquea por faltante; anular arrastra OP en borrador) y M4 (D-187: edición del pedido confirmado hasta comprobante con registro de cambios de precio). **M5 sacrificado** (modal con stock y «sin stock disponible»). Desplegado en la Ventana V-3 (2026-09-14). Al cierre de la sesión: lint/typecheck/format y 403/403 unitarios en verde, suite E2E completa: 265 verdes, 2 saltados (cupo PSE demo) y 1 caída transitoria (`ECONNRESET` a los 17 ms en `bobina-consumos-pdf-d172.spec.ts`, spec que la sesión no tocó; aislado pasó 3/3). Pendiente para el dueño: si `/produccion` y `/planta` priorizan las OP en borrador como lo hacía la cola (D-094/D-096). Handoff: `docs/handoff/f8-s2-flujo-comercial.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Sesión F8-S2b — M5 comercial (elegir con stock), edge del picker de bobina, cosméticos          | ✅ Cerrada (2026-09-13)    | M1 (D-188: `<select>` de producto → modal con el pool de bobinas por espesor/color y ML teórico, y el disponible por SKU, buscable, sin bloquear elegir sin stock; tarjeta «Cotizaciones sin stock disponible» en el Panel, sin flag guardado ni job — recalculada en cada lectura), M2 (edge de D-185: el picker de bobina entera ya no se vacía por la propia reserva temporal de la cotización que se edita) y M3 (dos cosméticos del handoff anterior: el campo de vigencia no se muestra al editar una cotización sin vencimiento, D-157; los diálogos de precio/cantidad del pedido ya no cambian de forma al cerrar). Ninguno sacrificado. Dos pasadas de `revisor` sin bloqueantes (hallazgos corregidos); `qa` sin defectos encontrados, sumó 6 casos de cobertura. Desplegado en la Ventana V-3 (2026-09-14). Al cierre de la sesión: lint/typecheck/format y 403/403 unitarios en verde, suite E2E completa: 272 verdes, 2 saltados (cupo PSE demo), 0 caídos. Sin migraciones nuevas. Pendiente, reportado y fuera de alcance por ser lógica: la clave de idempotencia de «agregar ítems» puede repetir el primer envío tras un fallo de red con las líneas cambiadas; la reserva temporal conserva su vencimiento original si la edición acorta la vigencia de la cotización. Handoff: `docs/handoff/f8-s2b-comercial-m5-cosmeticos.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Sesión F8-S3 — Planta: cola de OPs, órdenes en el pedido, borrador por OP                       | ✅ Cerrada (2026-09-13)    | M1 (D-189: la cola son las OPs de coberturas no iniciadas; prioridad manual migra del pedido a la OP con backfill; un solo ranking `compareQueueRank` para cola y `/planta`; la cola vieja pasa a «líneas sin orden»), M2 (D-190: las OPs viven en el detalle del pedido; `/produccion` sale del menú y redirige al historial dentro de `/planta`), M3 (D-191: borrador server-side de reportes por OP, validación inmediata y revalidación en un commit todo o nada con «Fila N:» e idempotencia), M4 (D-192: montar varias bobinas a la vez con peso inicial), M5 (D-193: reabrir una bobina cerrada desde el modal con paso explícito y asiento compensatorio del ajuste). Nada sacrificado. Desplegado en la Ventana V-3 (2026-09-14). Al cierre de la sesión: suite E2E completa 294 verdes, 2 saltados (cupo PSE), 0 caídos. Ver `docs/handoff/f8-s3-planta-cola-borrador.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| Sesión F8-S4 — Acabados con tipo, color y línea + deudas de integridad                          | ✅ Cerrada (2026-09-14)    | M0 (D-204: idempotencia al agregar al borrador, clave por huella de contenido, reserva temporal que nunca vence después de su cotización), M1 (D-203: acabado = tipo + color + línea, RAL y nombre único en colores, mapeo confirmado por el dueño) y M2 (D-203: el color de bobina e ítem de compra sale del acabado, con trigger en la base; editar bobina corrige el color cambiando el acabado). Nada sacrificado ni cortado a S4b. El importador de bobinas del brief no existe (no se adaptó nada). `revisor` API (2 altos) y web (1 bloqueante: el RAL no aceptaba ningún valor) corregidos; `qa` sin defectos de la app. Suite E2E completa local: 319 passed, 0 failed, 2 skipped. Commits locales, sin push (ventana V-4), salvo `a05fca1` (M0), que apareció en `origin/main` empujado desde este clon sin que lo ejecutara la sesión (CI verde, run 34908482884; a confirmar con el dueño). Handoff: `docs/handoff/f8-s4-acabados-integridad.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Sesión F8-S5 — Catálogo coherente + kardex clickable                                            | ✅ Cerrada (2026-09-15)    | D-205: la referencia de un movimiento de kardex se vuelve link (`refTargetType`/`refTargetId`, resueltos una sola vez en `InventoryService.findMovements`) y `dispatches.invoice_id` enlaza el despacho con su comprobante, pero solo desde el mostrador, que es el único punto que arma los dos uno a uno. Cierra además la deuda de catálogo de F8-S4 (M0). El campo nace en `dispatches` y no en `inventory_movements` por un hallazgo del propio E2E: esa tabla tiene un trigger que rechaza todo `UPDATE`. Handoff: `docs/handoff/f8-s5-catalogo-kardex.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Sesión F8-S6a — Carga de inventario inicial de bobinas                                          | ✅ Cerrada (2026-09-15)    | D-206: herramienta de inventario inicial como **excepción única y condicionada** a D-150, con sus cuatro condiciones escritas (hereda invariantes vía `CoilsService.create`, sin ruta HTTP, no es una compra —proveedor `isSystem` `SALDO`—, y el alcance de la excepción queda acotado). CLI `pnpm import:initial-inventory`, dry-run por defecto. Handoff: `docs/handoff/f8-s6a-inventario-inicial.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Sesión F8-S6a2 — Carga de inventario inicial de productos                                       | ✅ Cerrada (2026-09-15)    | D-207: la excepción de D-206 se extiende a productos por unidades (UPVC y reventa), misma herramienta (`--kind products`) y mismas cuatro condiciones. El alcance lo responde `ProductSource`, nunca el SKU ni la línea sola (la lección de D-131 con una pregunta nueva). Cerrada formalmente en F8-V4prep, cuando la suite completa corrió 0-rojo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| 8 — Auditoría, reportes, UAT                                                                    | 🟡 En curso                | F8-S1..F8-S4, F8-S5, F8-S6a, F8-S6a2, F8-V4prep y F8-S7 cerradas (nada sacrificado), Ventana V-4 completada, auditoría post-V4 cerrada y `main` de vuelta en verde (sesión CI-SANA). El cliente ya opera sobre producción con datos reales. Pendientes vivos en la sección «Post-V4» de este documento. RF-S1 (M0 higiene + precios de lista, D-214..D-217) cerrada — ver sección propia más abajo. **RF-S2 (auditoría, RF-95/96, D-218..D-227) cerrada y en producción desde la ventana S2 (2026-09-17)**: visor unificado en `/auditoria`, D-218/D-220 desplegadas, revisión `ayr-steel-erp-api-00037-njl`. RF-90..94 (los cinco reportes) sigue sin empezar; D-214 deja escrito que el plan de sesiones RF-S1..RF-S5 no es una renumeración de esos RF.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
## Ventana V-2 — Deploy único S9+S10+S10b+S11 (2026-09-11)
...
línea y sidebar reagrupado, D-174..D-176), S10b (sort de columna y cajas info a popover,
D-177/D-178) y S11 (escritorio compacto y color, D-179/D-180), más el saneamiento de docs de
esta ventana. Cero migraciones nuevas: `production` seguía y sigue en 55/55, sin drift
(`node scripts/migrations-status.mjs --branch production`).

**Respaldo Neon** antes de tocar nada: rama `respaldo-pre-deploy-20260912`
(`br-floral-pine-aedczki8`, parent `production`), creada vía `run` con `quiet: true` y
`--output json` (regla dura 5), sin imprimir ninguna cadena de conexión.

**Gate PSE.** `pnpm e2e:pse` dio 12/12 en rojo en el primer intento — la cuenta demo de
Nubefact seguía en su tope de 50 comprobantes. El dueño la vació y la segunda corrida cerró
12/12 en verde.

**Deploy.** API a Cloud Run (`pnpm deploy:api`), health verificado (`{"status":"ok","db":"ok"}`
en la revisión nueva). Web por push a `main` → Vercel.

**B-V2-5 (CI roja, no clasificable) y su fix, D-181.** La primera corrida de CI sobre estos 19
commits falló en `E2E Playwright (Neon ci)`, antes de correr un solo test: el guard de
`apps/api/prisma/reset-test-db.ts` rechazó el reset con «`ep-dry-butterfly-...` no es una base
de pruebas». Causa raíz: el guard (escrito en `eb1f15d`, Saneamiento E2E) comparaba el hostname
contra `ep-misty-band-`, copiando el **branch id** de la rama `ci` (`br-misty-band-ae9s41t7`) en
vez del hostname real de su **endpoint de cómputo** — dos identificadores independientes en
Neon que nunca coincidieron. El guard nunca había corrido contra la rama `ci` real hasta esta
ventana (local prueba contra Docker), así que el error salió recién ahora, al primer contacto.
Fix en `36441c1` (D-181): el prefijo pasa a `ep-dry-butterfly-`, verificado con `neonctl`, con
un comentario que deja escrito de dónde sale y cómo revalidarlo si vuelve a desalinearse.
Con el fix, la segunda corrida de CI cerró **verde en los tres jobs — 245 passed, 3 skipped,
...
(2026-09-10, 11:54 UTC) estaba rotado desde esa misma noche, pero `docs/PROGRESO.md` lo seguía
listando como «pendiente crítico». Corregido a «rotación ejecutada, incidente cerrado» — los
handoffs históricos en `docs/handoff/` no se tocaron, tal como pide la regla de la ventana.

**Backlog de Fase 8, verificado con lectura de código, no de memoria** (los cuatro puntos
siguen abiertos, sin cambios):

- **`weightKg` por línea en despachos con transporte.** El API (`dispatches.service.ts:243-250`)
  sigue exigiéndolo cuando `transferMode !== PICKUP` y la línea no se mide en `KGM`; el
  formulario web (`nuevo-despacho-view.tsx`) solo pide un `totalWeightKg` global y nunca manda
  `weightKg` por ítem. Cualquier línea en `MTR`/`NIU` con transporte real sigue sin poder
  despacharse desde la pantalla.
- **Aviso de mínimo en el POS.** `PriceFloorHint` (D-163) solo vive en `sales-document-form.tsx`
  ...
  el aviso.
- **Revisión del 1 % de merma normal con datos reales (D-165).** Sigue como pendiente
  explícito en `ARQUITECTURA.md`: hace falta 2-3 cierres de bobina reales para comparar contra
  el estándar, y todavía no hay esa muestra.
- **Búsqueda server-side en los selectores (`fetchAllForPicker`).** El tope sigue en 200
  (`MAX_PAGE_SIZE`) y `/customers` sigue ordenando `isActive desc, name asc` sin `search` en el
  picker; sin cambios desde el saneamiento E2E. No aprieta mientras la base activa esté por
  debajo del tope.

**Verificación de navegador en prod** (marcador V-2, cotización de prueba, PDF de bobinas,
badge del POS): a cargo del dueño, fuera del alcance de esta ventana.

## Ventana V-3 — Deploy del lote F8 (F8-S1..S3c) (2026-09-14) — CERRADA
...
migraciones** («Database schema is up to date!», `node scripts/migrations-status.mjs --branch
production`), API en la revisión `ayr-steel-erp-api-00032-bdn` con el 100 % del tráfico y
`/health` en `{"status":"ok","db":"ok"}`.

**Migraciones 55 → 61.** D-182 (idempotencia de creaciones repetibles), D-184 (la cotización nace
emitida), D-185 (reserva temporal), D-187 (registro de cambios de precio), D-189 (prioridad en la
OP) y D-191 (borrador de reportes). **Dos mutan datos** además de agregar: D-184 pasa toda
cotización en `DRAFT` a `EMITTED`, con la fecha de alta como fecha de emisión y sin quitar `DRAFT`
del enum; D-189 copia la prioridad vigente de cada pedido a sus OPs vivas (`DRAFT`/`IN_PROGRESS`).

**Gate PSE: aceptado por clasificación.** Los rojos de `pnpm e2e:pse` se clasificaron como
numeración retenida en la cuenta demo de Nubefact, no como una regresión del lote. La deuda de
los correlativos va a la sesión de salud E2E (abajo).

**B-V3-5 (CI del lote cancelada por timeout) — RESUELTA.** La CI sobre el lote se cortó tres
veces sin un solo rojo atribuible: `de8a49c` a los 75 min, y `9607c23` dos veces a los 110 min
(la segunda, a las 10:55 UTC, con Neon comprobado sano). La leyó la sesión F8-R1 (abajo). **La
CI completa del lote es el run 34875631463**: `9607c23` más instrumentación sola (reporter y
contador de consultas en `scripts/diag/`, cambios en `ci.yml`; cero producto, cero schema),
**305 passed, 3 skipped, 0 failed en 92 min**, runner en `centralus`. La rama que lo corrió
(`diag/f8-r1-instrumentacion`, commit `6a3cb1d`) no se mergeó y ya está borrada.

**Corrección de lo que se registró durante la ventana.** «Con Neon sano, la regresión es del
lote» era falso: **la lentitud era latencia de la región del runner × volumen de consultas, no el
lote.** Neon estaba sano, pero el RTT del runner a Neon cambia de una corrida a otra (16 ms en
`eastus`, 33 ms en `centralus`, ~80 ms en la corrida que se cortó) y nadie lo medía. El lote sube
el total de consultas de la suite ×1,64, sin encarecer cada una (D-201).
...
- **Backlog de rendimiento:**
  - `GET /sales/quotations/stock-shortages` (la tarjeta de faltantes del Panel, D-188) cuesta ~16
    ...
    conjunto solo crezca, así que el riesgo es de producción, no de CI.
  - En CI el API paga ~12 ms por consulta por encima de un `SELECT 1` medido desde un proceso
    aparte (42 contra 30 ms). Posible espera por el pool de 5 en ráfagas de `Promise.all`; mueve
    ~×1,3.
  - Reducir consultas por test, como higiene; workers en paralelo se reevalúa después del cambio
    de base.

## Sesión F8-R1 — Diagnóstico de la lentitud del E2E en CI (2026-09-14) — CERRADA

Sesión de **diagnóstico**: FASE 1 completa, causa nombrada y **sin fix de producto, porque no
hay regresión de producto**. Análisis completo en `docs/analisis/f8-r1-rendimiento.md`; la
decisión es D-201.

- **Herramientas locales** (quedan en el repo, documentadas en `docs/ENTORNOS.md` → «E2E con
  latencia»): proxy de latencia con contador de round-trips delante del Postgres de Docker,
  runner desde worktree con builds de producción y pool de 5, reporter por test y comparador.
- **Descartados con medición:** CPU del runner y de la base, churn de conexiones, clientes Prisma
  extra, `stock-shortages` (en la suite nunca hay más de 2 cotizaciones emitidas a la vez), PDF a
  R2, PSE, polling del web y `next dev`.
- **La medición que decidió:** CI instrumentada con consultas y su duración por test. La forma
  es uniforme por consulta: mismas consultas (×1,02 contra local), sin tests que exploten y sin
  acumulación. El A/B sobre la base (`e184ca1`, runner `eastus`) dio 18,8 ms por consulta con
  16 ms de RTT. HEAD dio 80,0 ms en una corrida y 42,4 ms en otra con 33 ms de RTT, con las
  mismas consultas (×0,99), y un `SELECT 1` desde un proceso aparte estable durante toda la
  suite.
...
## Sesión F8-S4 — Acabados con tipo, color y línea + deudas de integridad (2026-09-14) — CERRADA

Origen: feedback del cliente («el acabado debería llevar color… algunas veces me olvidé de ingresar
el color»). Decisiones D-203 y D-204. **Todo en commits locales, sin push**: se acumula para la
ventana V-4.

- **M0 (D-204).**
  - «Agregar al borrador» (D-191) reclama clave de idempotencia.
  - La clave del cliente se guarda por huella del contenido. Corregir las líneas tras un corte de
    red es otro envío, y volver al contenido anterior reusa su clave.
  - La reserva temporal se recorta al fin de la vigencia de la cotización. Acortar solo la vigencia
...
- **M1 (D-203).**
  ...
  - `colors` gana `ral_code` y nombre único sin distinguir mayúsculas.
  - Mapeo del PASO 0, confirmado por el dueño:
    - ALZ-ROJO-3002 → Rojo 3002.
    - ALZ-3020 → color nuevo «Rojo tráfico» 3020; sus 2 bobinas pasan a ese color.
    - ALZ-AZUL → Azul 5010.
    - Los tres son prepintados de Coberturas Aluzinc.
  - Colores de ejemplo en la migración y en el seed (solo sobre catálogo vacío).
  - Pantallas de Acabados y Catálogo → Colores.
- **M2 (D-203).**
  - Trigger `color_from_finish` sobre `coils` y `purchase_items`.
  - Compra de bobinas sin campo de color: el acabado tiene que ser de la línea de la compra, y un
...
- **Revisión.**
  - `revisor` web, bloqueante: el RAL no aceptaba ningún valor real. En el regex se perdió la barra
  ...
  - `revisor` API, alto 2: completar un acabado sin tipo repintaba sus bobinas en masa, sin revisar
    pool, OPs montadas ni línea. Ahora se rechaza.
  - También se corrigieron: un lock que podía trabarse con la FK de una bobina nueva, el audit del
    cambio de acabado y la auditoría de la reserva vencida al editar.
- **Suite E2E completa local: 319 passed, 0 failed, 2 skipped.** Los 2 skipped son los de mostrador
  sin PSE. Specs existentes sin tocar: los helpers compran cada bobina con un acabado de su línea y
  su color. Hay 7 tests nuevos en `e2e/tests/acabados-d203.spec.ts`. Unitarios: 417/417.
- **No hecho, con motivo.** El brief pedía adaptar el importador de bobinas con contradicción de
...
- **Pendientes para la ventana V-4:**
  - Producción se limpia físicamente antes de V-4 (decisión del dueño). Después de la limpieza, y
    antes de la migración que pase `finishes.kind`/`business_line_id` a `NOT NULL`, completar desde
...
finishes WHERE kind IS NULL`.
  ...
  - Deuda de catálogo (fuera de alcance): un producto de coberturas con acabado y color que no
    coinciden no encuentra bobina (D-086), y el catálogo acepta un producto con un acabado de otra
    línea.
...
Auditoría de solo lectura sobre todo lo cerrado entre F8-S4 y la ventana V-4, hecha con la
...
no está acá, no está vivo.

### Lo que se verificó (y lo que no coincidía)

- **Código y ramas.** `main` limpio, `local == origin/main`, 0 commits sin push, sin stash, sin
  ramas locales de más, sin worktrees. La era de commits locales terminó con V-4, como se
  esperaba. Neon tiene **10 ramas** y `production` sigue siendo la default: las cuatro de
  trabajo (`production`, `dev`, `ci`, `demo` — el brief de la auditoría se olvidaba de `demo`)
...
- **Producción, esquema y despliegue.** `migrate status` **66/66 sin drift**. Cloud Run sirve
  ...
  verde (health, login, 5 líneas, 174 productos, valorizado, bobinas, reporte mensual).
- **La carga de inventario de V-4 es exactamente la que se documentó**: 15 bobinas con
  `externalCode` (`SALDO-…`), **46.805,000 kg**, **S/ 132.520,06**, 15 movimientos `IMPORT`
  con `operationDate` 2026-09-15, las 2 `ALZ-NATURAL` sin color. Catálogo intacto: 174
  productos (173 activos), 6 colores, **9 acabados con `kind` y línea en todos** y ninguno
  `PREPINTADO` sin color — D-209 sostiene su invariante sobre datos reales. Los 56 SKU de
  Metallic Roofing tienen `roofingKind` y acabado.
- **Producción ya está en uso operativo real, y eso cambia los números del cierre.** Entre el
  ...
  más** por esa compra recibida (`XSY-…`, 13.552 kg / S/ 37.001,03, `operationDate` 2026-08-25),
  **3 pedidos** en `IN_PRODUCTION`, **5 OPs de coberturas cerradas** con 6 reportes, y **3
  facturas manuales `ACCEPTED`** (D-153, correlativos 1352/1354/1360 de la serie histórica,
  ...
  **2 SKU con saldo de producto terminado** (COB030ROJO, COB040ROJO) que salieron de esas OPs.
  Sin saldos negativos. **Cualquier verificación futura tiene que contar desde acá, no desde
  los 15/46.805 de la ventana.**
- **Los proveedores del archivo de compras sí se crearon** (era una pregunta abierta): hay
  **5** — el `SALDO` del sistema (D-206) y cuatro reales, `JRSTEE`, `XSY`, `JAVI` y `YISENT`,
  todos con RUC y activos, creados el 15-09. Con ellos se cargaron las 7 compras de arriba.
- **Salud del catálogo, solo lectura.** `check:roofing-catalog` sin nada que corregir.
  `check:price-floor` informa **0 SKU activos con precio de lista**: nadie está por debajo del
  piso de D-163 porque **no hay precios de lista cargados** — las 70 cotizaciones se hicieron
  con precio tipeado. Es un dato de estado, no un defecto, pero explica por qué el piso de
  D-163 y el aviso del POS no alcanzan hoy a ninguna venta.
- **Documentación.** Las entradas de F8-S4, F8-S5, F8-S6a, F8-S6a2, F8-V4prep y la Ventana V-4
  están completas, y D-203..D-209 en §0.2 también. Dos huecos, corregidos en esta auditoría:
  el cambio de `MAX_BACKDATED_ISSUE_DAYS` de 7 a 90 (commit `201185c`) estaba en `main` **sin
  decisión ni entrada** — ahora es **D-210**; y el cierre de F8-V4prep afirmaba que «el
  rollover de correlativos de D-202 (2028-04-22) sí quedó en el checklist, con su cita
  exacta», pero `docs/ENTORNOS.md` no contenía la cadena `2028` en ninguna parte. El rollover
...
1. ~~**CI en rojo por el wrapper del importador (runner).**~~ **RESUELTO (CI-SANA,
   ...
   ese wrapper resuelve `local-e2e` con `dbUrl(DB_NAME_E2E)` —
   `postgresql://ayr:ayr_local@127.0.0.1:5434/ayr_local_e2e`, el Docker de la máquina del
   agente — mientras que en CI la base es la del runner,
...
4. **Stock de UPVC y reventa: segunda tanda pendiente.** La carga de V-4 fue **solo bobinas**.
   ...
   (D-207). La herramienta ya está probada y no necesita trabajo.
5. **`pnpm e2e:pse` nunca se validó contra Nubefact con los correlativos de 8 dígitos de
   D-202.** Se omitió en el modo exprés de V-4. Es la única verificación que queda de que la
   cuenta demo acepta un correlativo de 8 dígitos como primer número de una serie. Necesita
   cupo de la cuenta demo: **coordinar con el dueño** antes de correrlo.
6. **F8-S7 (pulido) no corrió.** No hay entrada ni handoff: el prompt se entregó y quedó en
   cola. Alcance: label de acabado/color, `dispatchId` opcional al facturar (la dirección que
   D-205 dejó escrita — hoy `POST /invoicing/documents` sigue sin declararlo; verificado) y
   cosméticos.
7. **COMPRAS.xlsx: decisión cerrada, no reabrir.** Las compras históricas **no se importan**;
   la historia vive en Excel. Queda escrito acá para que ninguna sesión futura lo reintente.
   Ojo con la lectura de los datos: las 7 compras que hoy están en producción **no** son esa
   importación — las cargó el dueño por la app el 15-09, y 6 de ellas siguen en `DRAFT`.
...
- RF-90..96: auditoría, reportes y UAT — el grueso de la Fase 8, sin empezar.
...
- **Pendientes post-ventana (dueño: próxima sesión corta):**
  ...
  2. **CI, runner:** los 6 specs del importador (3 de `inventario-inicial-f8s6a.spec.ts` y 3 de
     ...
     del runner. La guarda de esquema lo reporta como «falta D-206». Nunca habían corrido en CI.
     (Eran 6, no 4: la auditoría post-V4 los contó en el log de la corrida 35048537491.)
