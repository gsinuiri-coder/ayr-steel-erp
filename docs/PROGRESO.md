...
| 7e — Venta de bobinas + catálogo estructurado + cotización | 🟡 En curso (2026-09-06) | A+B+C+D hechos (D-116..D-119): venta de bobina completa, defaults de bobina, catálogo estructurado, cotización/pedido multi-línea + duplicar. lint/typecheck/test/build verde. E (corte solo Drywall + plan por SKU de fleje) queda pendiente. Sin migrar a prod, sin E2E, sin push. |
