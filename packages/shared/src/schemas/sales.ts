 ...
 *
 * Cota, a propósito (D-255; SM-P2-1 del segundo modelo): la suma cruda puede separarse del total
 * hasta un céntimo, y el valor y el total se redondean cada uno por su lado (medio céntimo cada
 * uno), así que el IGV guardado —la resta— puede quedar hasta unos **S/ 0.02** del IGV crudo del
 * papel en el peor caso teórico. El chequeo contra el 18 % solo descarta tríos; no agrega
 * distancia. Es la política del dueño, no un límite que haya que ajustar.
 */
